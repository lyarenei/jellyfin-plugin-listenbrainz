...
public class FavoriteSyncServiceTests
{
    ...
    [Fact]
    public void SyncToListenBrainz_RecordingMbidAvailable()
    {
        _libraryManagerMock
        ...
        _service.SyncToListenBrainz(_item.Id, jellyfinUserId);
    ...
    [Fact]
    public void SyncToListenBrainz_RecordingMbidNotFound()
    {
        var noMbidItem = new Audio
        {
            Id = _item.Id,
        ...
        var invalidMetadata = new AudioItemMetadata { RecordingMbid = string.Empty };
        _musicBrainzClientMock
            .Setup(m => m.GetAudioItemMetadata(_item))
            .Returns(invalidMetadata);
